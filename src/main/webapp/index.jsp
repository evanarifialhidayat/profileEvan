...
<link href="pages/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">
 <link href="pages/lib/animate/animate.min.css" rel="stylesheet">
  <link href="pages/lib/font-awesome/css/font-awesome.min.css" rel="stylesheet">
  <link href="pages/lib/ionicons/css/ionicons.min.css" rel="stylesheet">
  <link href="pages/lib/magnific-popup/magnific-popup.css" rel="stylesheet">
...
<body>
  <header id="header" style="padding-top: 10px;">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
          <h1><a href="#intro" class="scrollto"><img src="pages/img/evan-logo.png" alt=""></a></h1>
      </div>
  ...
  <section id="intro">
    ...
    <div class="product-screens">
      ...
      <div class="product-screen-1 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.6s">
        <img src="pages/img/product-screen-1.png" alt="">
      </div>

      <div class="product-screen-2 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.6s">
        <img src="pages/img/product-screen-2.png" alt="">
      </div>

      <div class="product-screen-3 wow fadeInUp" data-wow-duration="0.6s">
        <img src="pages/img/product-screen-3.png" alt="">
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 features-img">
            <img src="pages/img/product-features.png" alt="" class="wow fadeInLeft">
          </div>
    ...
    <section id="gallery" style="padding-top: 0px;">
      <div class="container-fluid">
        <div class="row no-gutters">
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="pages/img/gallery/gallery-1.jpg" class="gallery-popup">
                <img src="pages/img/gallery/gallery-1.jpg" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="pages/img/gallery/gallery-2.jpg" class="gallery-popup">
                <img src="pages/img/gallery/gallery-2.jpg" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="pages/img/gallery/gallery-3.jpg" class="gallery-popup">
                <img src="pages/img/gallery/gallery-3.jpg" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="pages/img/gallery/gallery-4.jpg" class="gallery-popup">
                <img src="pages/img/gallery/gallery-4.jpg" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="pages/img/gallery/gallery-5.jpg" class="gallery-popup">
                <img src="pages/img/gallery/gallery-5.jpg" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="pages/img/gallery/gallery-6.jpg" class="gallery-popup">
                <img src="pages/img/gallery/gallery-6.jpg" alt="">
              </a>
            </div>
          </div>
  ...
  <script src="pages/lib/easing/easing.min.js"></script>
  <script src="pages/lib/wow/wow.min.js"></script>
